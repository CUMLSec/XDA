...
@register_task('instbound')
class InstboundTask(FairseqTask):
    """
    Instruction boundary prediction (classification) task.
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return InstboundTask(args, data_dict, label_dict)
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        src_tokens = StripTokenDataset(src_tokens, self.source_dictionary.eos())
        ...
        src_labels = StripTokenDataset(src_labels, self.label_dictionary.eos())

        src_labels = OffsetTokensDataset(src_labels, offset=-self.target_dictionary.nspecial)
        src_labels = RightPadDataset(src_labels, pad_idx=self.target_dictionary.pad() - self.target_dictionary.nspecial)
