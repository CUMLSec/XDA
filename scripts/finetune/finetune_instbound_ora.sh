...
INSTBOUND_PATH=checkpoints/finetune_instbound_ora
...
CUDA_VISIBLE_DEVICES=1 python train.py data-bin/finetune_instbound_ora/ \
  --max-positions 512 \
  ...
  tee result/finetune_instbound_ora
